...
/**
 * Item in *Integrations → Default → Primary → Integration Icons*
 */
export interface IntegrationsSliceDefaultPrimaryIntegrationIconsItem {
  /**
   * Icon field in *Integrations → Default → Primary → Integration Icons*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
...
export interface IntegrationsSliceDefaultPrimary {
  ...
  /**
   * Integration Icons field in *Integrations → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
