  ...
  return (
    <div className="relative" ref={container}>
      ...
      {isFilled.richText(slice.primary.heading) && (
        <h1 className="hero__heading text-balance text-5xl font-medium tracking-tight opacity-0 md:text-7xl">
      ...
      {isFilled.image(slice.primary.image) && (
        <div className="hero__image glass-container mt-16 w-fit opacity-0">
          <div className="hero__glow absolute inset-0 -z-10 bg-blue-600/30 opacity-0 blur-2xl filter" />
          <PrismicNextImage
